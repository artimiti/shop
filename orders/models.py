...
class Order(models.Model):
    ...
    customer_email = models.EmailField(null=True, default=None)
    customer_phone = models.CharField(max_length=48, blank=True, null=True, default=None)
    customer_order = models.CharField(max_length=128, blank=True, null=True, default=None)
